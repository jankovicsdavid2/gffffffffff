...
public class Warrior extends Characters{
    ...
    public void foundLoot(Scanner sc) {
        ...
        if (chance.nextInt(10) == 9) {
            System.out.println("It`s a weapon! It ill grant extra damage to your attacks.");
            lootType = 2;
        } else {
            System.out.println("It`s a health potion! You can use it to restore 30 health points with it.");
            lootType = 1;
        }
        ...
        if (lootType == 1) {
            ...
            strength = strength + chance.nextInt(5) + 1;
        }
    }
